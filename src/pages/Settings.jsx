        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4">
          {ITEM_CATEGORIES.map((cat) => (
            <button
              ...
              className="group flex flex-col items-start justify-between gap-3 rounded-2xl border border-slate-800 bg-slate-900/80 px-4 py-4 text-left transition-all duration-200 hover:border-purple-500/60 hover:bg-slate-900"
            >
              ...
              <div className="w-full flex items-center justify-between gap-3">
                <span className="text-xs text-slate-400 truncate">{cat.desc}</span>
